...
test('the navItem when fixedWidth is auto', () => {
...
test('the navItem when fixedWidth is a measurement', () => {
...
test('the navBackground classes when hoverTransition is slideRight', () => {
